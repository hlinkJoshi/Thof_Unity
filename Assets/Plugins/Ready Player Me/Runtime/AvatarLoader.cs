...
namespace ReadyPlayerMe
{
    ...
    {
        // this variable created by dhvanil for accessing avatar in another script
        public static GameObject loadedAvatarInGame;
        ...
        private async void Load(string url)
        {
            ...
            else
            {
                ...
                loadedAvatarInGame = avatar as GameObject;
